...
$sql = "UPDATE $dbtable_users SET correo_usu='$gmail',nombre='$nombre',apellido1='$apellido1',apellido2='$apellido2',direccion='$direccion',contrasena='$contrasena' WHERE usuario='$usuario'";
